...
joylink_dev_get_idt(jl2_d_idt_t *pidt)
{
	...
	*/
	...
	log_info("this device get idt,by xjl");
...
joylink_dev_get_user_mac(char *out)
{
	...
	*/
	...
	log_info("this device get mac,by xjl");
	return -1;
}
...
joylink_dev_get_jlp_info(JLPInfo_t *jlp)
{
	...
	*/
    ...
    log_info("get jlp info,begin,feedid(%s),jlp->localKey(%s),accesskey(%s)",user_jlp.feedid,user_jlp.accesskey,user_jlp.localkey);
	return ret;
}
...
joylink_dev_get_modelcode(char *out_modelcode, int32_t out_max)
{
	...
	*/
	...
	log_info("this device joylink_dev_get_modelcode,by xjl");
...
joylink_dev_lan_json_ctrl(const char *json_cmd)
{
	...
	log_info("this device joylink_dev_lan_json_ctrl,by xjl");
